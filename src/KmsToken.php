...
abstract class KmsToken extends Token
{
    ...
    /**
     * Create the self::token instance property from a JSON string that includes
     * a hash secret encrypted with the AWS KMS service, and use this hash secret
     ...
     * @return string
     */
    protected function getPlaintextEncryptionKey(CacheItemPoolInterface $cache = null)
    {
        if ($cache === null) {
     ...
     * @return string
     */
    final protected function decryptCipherTextEncryptionKey()
    {
    ...
    /**
     * Create a JWS object using a hashing secret generated by the AWS KMS service
     * and set it the self::token instance property
     *
     * @todo Specify void return type in PHP 7.1
     *
     ...
     * @returns array
     */
    protected function getTokenKeyHeaders(string $clientAppId, string $ciphertext): array
    {
        return [
     ...
     * @returns Result
     */
    protected function generateKeyData(string $clientAppKmsMasterKeyId): Result
    {
